...
class PostController extends Controller
{
    ...
    public function BlogCatStore(Request $request)
    {
        ...
        $notification = array(
            'message' => 'دسته وبلاگ با موفقیت اضافه شد',
            'alert-type' => 'success'
             );
    ...
    public function DeleteBlogCat($id)
    {
        ...
        $notification = array(
            'message' => 'دسته وبلاگ با موفقیت حذف شد',
            'alert-type' => 'success'
             );
             return Redirect()->back()->with($notification);
    }
    ...
    public function UpdateBlogCat(Request $request,$id)
    {
        ...
        $notification = array(
            'message' => 'دسته وبلاگ با موفقیت بروزرسانی شد',
            'alert-type' => 'success'
             );
    ...
    public function store(Request $request)
    {
        ...
        $data['post_title_fa'] = $request->post_title_fa;
        $data['category_id'] = $request->category_id;
        $data['details_en'] = $request->details_en;
        $data['details_fa'] = $request->details_fa;
    ...
    public function UpdatePost(Request $request,$id)
    {
        ...
        if ($post_image) {
            ...
            DB::table('posts')->where('id',$id)->update($data);
            $notification = array(
                'message' => ' پست بدون تصویر بروزرسانی شد ',
                'alert-type' => 'success'
                 );
                 return Redirect()->route('all.blogpost')->with($notification);

...
class ProductController extends Controller
{
    public function ProductView($id,$product_name)
    {
        ...
        return view('pages.product_detalis',compact('product','product_color','product_size'));
    }
    ...
    public function ProductsView($id)
    {
        ...
        $products = DB::table('products')->where('subcategory_id',$id)->paginate(25);
    ...
    public function CategoryView($id)
    {
        ...
        $category_all = DB::table('products')->where('category_id',$id)->paginate(25);

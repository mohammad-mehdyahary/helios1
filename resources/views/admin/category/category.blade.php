...
<div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">لیست دسته ها
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                      ...
                      <a href="{{ URL::to('delete/category/'.$row->id) }}" class="btn btn-sm btn-danger">حذف</a>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="نام دسته" name="category_name">
  </div>

...
<div class="sl-mainpanel">
      ...
      <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">بروزرسانی محصول  
            <a href="{{ route('all.product') }}" class="btn btn-success btn-sm pull-right">همه محصولات</a>
          </h6>
          <p class="mg-b-20 mg-sm-b-30">بروزرسانی محصول  به گروه</p>
        ...
        @csrf
          <div class="form-layout">
            ...
            <div class="form-layout-footer">
              <button class="btn btn-info mg-r-5">بروزرسانی</button>
 ...
 <div class="sl-pagebody">
      <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">بروزرسانی تصاویر </h6>
        ...
        @csrf
              ...
              <button  type="submit" class="btn btn-sm btn-warning">بروزرسانی تصاویر</button>
             </form>
           </div>
        </div>
    </div><!-- sl-mainpanel -->
